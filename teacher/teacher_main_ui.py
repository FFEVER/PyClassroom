...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.description_label.setGeometry(QtCore.QRect(100, 210, 161, 141))
        ...
        self.pushButton.setGeometry(QtCore.QRect(380, 120, 131, 31))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.tab)
        self.pushButton_2.setGeometry(QtCore.QRect(380, 230, 131, 31))
        self.pushButton_2.setObjectName("pushButton_2")
        self.tabWidget.addTab(self.tab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.listWidget = QtWidgets.QListWidget(self.tab_2)
        self.listWidget.setGeometry(QtCore.QRect(40, 50, 501, 241))
        self.listWidget.setObjectName("listWidget")
        self.lineEdit = QtWidgets.QLineEdit(self.tab_2)
        self.lineEdit.setGeometry(QtCore.QRect(40, 340, 401, 21))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton_3 = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_3.setGeometry(QtCore.QRect(450, 340, 91, 21))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Start/Stop streaming"))
        self.pushButton_2.setText(_translate("Form", "Exit room"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Form", "Main"))
        self.pushButton_3.setText(_translate("Form", "Post"))
